			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> Add new Course
					</div>
					<div class="card-body">
						<font color="red">${message}</font>
						<form:form action="doaddCourse" method="post" modelAttribute="course">
							<div class="form-group">
								<label>Course_Code</label>
								<form:input type="text" path="code" placeholder="JAV"
									class="form-control" />
							...
							<div class="form-group">
								...
								<form:input type="text" path="name"
									placeholder="JAVA Tech" class="form-control" />
									<form:errors path="name" cssClass="errors"  />
							</div>
							<div class="form-group">
								<label>Course_Teacher</label>
								<form:select path="idUser" items="${teachers}"
									itemLabel="profile.name" itemValue="id" class="form-control" />
							</div>
							<div class="form-group">
								<label>Course_Time</label>
								<form:input type="text" path="time"
									placeholder="150 hours" class="form-control" />
							...
							<div class="form-group">
								...
								<form:input type="text" path="fee"
									...
									<form:errors path="fee" cssClass="errors"  />
							</div>
							<div class="form-group">
								<label>Start Date</label>
								<form:input type="text" path="startDate"
									placeholder="10/01/2019" class="form-control" />
									<form:errors path="startDate" cssClass="errors"  />
							</div>
							<div class="form-group">
								<label>End Date</label>
								<form:input type="text" path="endDate"
									placeholder="10/03/2019" class="form-control" />
